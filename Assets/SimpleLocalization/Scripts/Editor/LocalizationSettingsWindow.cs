...
namespace Assets.SimpleLocalization.Scripts.Editor
{
    public class LocalizationSettingsWindow : EditorWindow
    {
        ...
        [UnityEditor.MenuItem("Window/◆ Simple Localization/Settings")]
        public static void ShowWindow()
        {
            GetWindow<LocalizationSettingsWindow>("Localization Settings");
        }

        [UnityEditor.MenuItem("Window/◆ Simple Localization/Reset")]
        ...
        [UnityEditor.MenuItem("Window/◆ Simple Localization/Help")]
