...
public class SpearAbility : Ability
{
    ...
    {
        var carPos = PlayerCarController.Instance.transform.position;
        cooldownTimer = 0;
        ...
        if (cols.Length > 0)
        {
            ...
            Instantiate(spearPrefab, PlayerCarController.Instance.transform.position, Quaternion.LookRotation(-relativePos));
        }
    }
